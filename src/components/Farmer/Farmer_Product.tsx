...
import products from "../../../public/data/FarmerProduct.json";
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href={`/Farmer-Panel/Product/Edit/${product.id}`} className="p-2 flex justify-center items-center px-4 rounded-sm bg-green-300 hover:bg-green-500 gap-1 text-white ">
                             <MdEdit />
                             <span>Edit</span>
                        </Link>
                        <Link href={""} className="p-2 px-4 flex justify-center items-center rounded-sm bg-red-300 hover:bg-red-500 text-white gap-1">
                            <MdDelete />
                            <span>Delete</span>
                        </Link>
                    </div>
